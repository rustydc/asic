...
def layer_die() -> Drawing:
    ...
    d.box(40, 430, 220, 120, "Memory unit", ["mover: state/hist DMA", "append: window, block,", "index, block sums", "index_scan + topk", "record_reader -> rows"], "mem")
    d.edge([(145, 380), (145, 430)], "e2")
    d.edge([(30, 206), (30, 490), (40, 490)], "ec")
    d.box(290, 450, 120, 80, "Arbiter", ["4 requesters", "one req in flight", "per requester"], "mem")
