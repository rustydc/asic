...
| Need | Balls |
| --- | ---: |
| Signals (24 link, 304 memory, 14 management) | 342 |
| Signal ground returns (1 per 4) | 86 |
| Core rail | 43 |
...
| VDD_CORE | 185 | interior checkerboard |
| GND | 231 | interior checkerboard and lane returns |
