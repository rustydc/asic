...
The ring is a regular 11-gon of 58 mm side (103 mm circumradius) centred at (140, 190), one ring node per vertex, each chip rotated tangentially (its link-out edge faces the next chip 32.7 degrees round), memories outward, core regulator inward. Every hop is one 36-lane ribbon on In2.Cu at 0.4 mm lane pitch (outer-column and dogbone vias interleaved), 0.1 mm tracks, leaving and entering the ports straight for 8 mm with two bends between. Limit 80 mm per `board.yaml`.

| Hop | Shortest lane (mm) | Longest lane (mm) | Sharpest bend | Within limit |
| --- | ---: | ---: | ---: | --- |
| U_FPGA -> U_A0 | 24.9 | 39.2 | 20 deg | yes |
| U_A0 -> U_A1 | 23.7 | 38.0 | 16 deg | yes |
| U_A1 -> U_A2 | 23.7 | 38.0 | 16 deg | yes |
| U_A2 -> U_A3 | 23.7 | 38.0 | 16 deg | yes |
| U_A3 -> U_A4 | 23.7 | 38.0 | 16 deg | yes |
| U_A4 -> U_A5 | 23.7 | 38.0 | 16 deg | yes |
| U_A5 -> U_A6 | 23.7 | 38.0 | 16 deg | yes |
| U_A6 -> U_A7 | 23.7 | 38.0 | 16 deg | yes |
| U_A7 -> U_H0 | 23.7 | 38.0 | 16 deg | yes |
| U_H0 -> U_H1 | 23.7 | 38.0 | 16 deg | yes |
| U_H1 -> U_FPGA | 24.9 | 39.2 | 20 deg | yes |
