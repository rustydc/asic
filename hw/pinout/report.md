...
Rated at 50000 tokens/s the core rail draws 184 A (3.0 pJ per MAC, 0.8 V), one ball per 0.5 A.
...
| --- | ---: | ---: | ---: | --- |
| FCBGA400_20x20_P1.0 | 400 | 204 | 23 mm | 400 balls, 1042 needed |
| FCBGA784_28x28_P0.8 | 784 | 300 | 23 mm | 784 balls, 1042 needed |
...
| 2 memory channels | 130 | N rows, lanes with a ground after each |
...
* the die-edge assignment it implies: link ports on the W and E die edges, the memory PHYs on the N edge, management on the south;
* the core current (184 A at the rating, 184 A at 50K tokens/s) for the bump map and the substrate power planes.
