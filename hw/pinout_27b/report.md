...
Rated at 234000 tokens/s the core rail draws 656 A (0.35 pJ per MAC, 0.8 V), one ball per 0.5 A.
...
| --- | ---: | ---: | ---: | --- |
| FCBGA1225_35x35_P0.8 | 1225 | 384 | 29 mm | 1225 balls, 2778 needed |
| FCBGA2025_45x45_P1.0 | 2025 | 504 | 48 mm | 2025 balls, 2778 needed |
| FCBGA3025_55x55_P1.0 | 3025 | 624 | 55 mm | **selected** |
| FCBGA3844_62x62_P1.0 | 3844 | 708 | 62 mm | not needed |

## Ball map

FCBGA3025_55x55_P1.0: 55 x 55 at 1.0 mm, 55 mm body.

| Use | Balls | Where |
| --- | ---: | --- |
| link_in | 36 | W edge, columns 1-2, rows 19-36 |
| link_out | 36 | E edge, same rows |
| memory | 0 | in the package (HBM on the interposer), no balls |
| mgmt, jtag, refclk, strap | 14 | S row |
| VDD_CORE | 1422 | interior checkerboard |
| GND | 1471 | interior checkerboard and lane returns |
...
* the core current (656 A at the rating, 150 A at 50K tokens/s) for the bump map and the substrate power planes.
